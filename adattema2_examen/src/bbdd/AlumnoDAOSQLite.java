...
public class AlumnoDAOSQLite {
	// Variables
	private Connection con = null;
	private static AlumnoDAOSQLite instance = null;
	
	// Constructor
	private AlumnoDAOSQLite() throws SQLException, ClassNotFoundException {
		con = DBConexionSQLite.getConnection();
	}
	
	// Métodos
	public static AlumnoDAOSQLite getInstance() throws SQLException, ClassNotFoundException {
		if (instance == null) {
			instance = new AlumnoDAOSQLite();
		}
		return instance;
	}
