...
public class CursoDAOMySQL {
	...
	private static CursoDAOMySQL instance = null;
	
	// Constructor
	private CursoDAOMySQL() throws SQLException, ClassNotFoundException {
		con = DBConexionMySQL.getConnection();
	}
	
	// Métodos
	public static CursoDAOMySQL getInstance() throws SQLException, ClassNotFoundException {
		if (instance == null) {
