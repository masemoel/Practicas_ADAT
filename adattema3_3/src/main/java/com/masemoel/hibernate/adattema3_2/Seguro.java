...
public class Seguro {
	...
	private String nif, nombre, ape1, ape2, alergia;
	...
	public Seguro(int idSeguro, String nif, String nombre, String ape1, String ape2, int edad, int numHijos, Date fechaCreacion, String alergia) {
	...
	public String toString() {
		return "Seguro [Id seguro=" + idSeguro + ", NIF=" + nif + ", nombre=" + nombre + ", apellido 1=" + ape1 + ", apellido 2=" + ape2 + ", edad=" + edad + ", número de hijos=" + numHijos + ", fecha de creación=" + fechaCreacion + ", alergias=" + alergia + " y " + asistencias + "]";
	}
